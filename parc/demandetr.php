...
<div class="search-container">
    <form action="detaildt.php" method="GET">
...
<h4 class="titre2">   " Liste des demandes traitées "</h4>
...
$requete = $bdd->query('SELECT  * From copie_info_emp join confirme on copie_info_emp.Ref =confirme.ref' );
...
echo '<td>'.$contacts['inventaire'].'</td>';
echo '<td>'.$contacts['montant_chiff'].'</td>' ; 
echo '<td>'.$contacts['montant_lett'] .'</td>';
'</tr>';
